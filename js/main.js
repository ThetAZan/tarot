$(document).ready( function() {
    ...
    $('.cc1').css({'background':'url(img/'+item1+'.png) top center no-repeat'});
    $('.cc2').css({'background':'url(img/'+item2+'.png) top center no-repeat'});
    $('.cc3').css({'background':'url(img/'+item3+'.png) top center no-repeat'});
    polojenie = [];
    ...
    $('.taro_card').click(function(){
        if($(this).attr('data-rel') == 'notchecked')
        {
            ...
            $(this).css({
                'background':'url(./img/' + $(this).attr('data-id') + $(this).attr('data-polojenie') + '.png) no-repeat center',
